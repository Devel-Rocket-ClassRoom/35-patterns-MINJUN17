...
//    {
//        Console.WriteLine($"값이: {s}");
//    }
//    else if(obj is null)
//    {
//        Console.WriteLine($"값이: null");
//    }
//    else
//    {
...
//Console.WriteLine($"15살 유효한 나이: {IsTeenager(15)}");
//Console.WriteLine($"25살 유효한 나이: {IsTeenager(25)}");
...
//Console.WriteLine($"jone: {IsJanetOrJohn("john")}");
...
//{
//    Console.WriteLine($"{Person.Name}({Person.Age}세): {DescribePerson(Person)}");
//}
...
//{
//    Console.WriteLine($"{person.Name}: {DescribeDetailed(person)}");
//}
...
{
    Console.WriteLine($"캐릭터{i} (HP:{character[i].Health}, MP:{character[i].Mana}): {GetCharacterStatus(character[i])}");
}
